  ...
  return (
    <div className="w-full max-w-md">
      ...
      <div className="flex items-center justify-center gap-2 mb-8 select-none">
        <img src="/logo-black.png" alt="Logo" className="h-8 w-8 object-contain dark:hidden" />
        <img src="/logo-white.png" alt="Logo" className="h-8 w-8 object-contain hidden dark:block" />
        <span className="text-2xl font-bold tracking-tight text-foreground">SchemaLab</span>
      </div>
      ...
      <div className="rounded-2xl border border-border bg-card p-8 shadow-2xl">
        ...
        <form onSubmit={handleEmailAuth} className="space-y-4">
          <div className="space-y-2">
            <Label htmlFor="auth-email" className="text-foreground">Email address</Label>
            <Input
              id="auth-email"
              type="email"
